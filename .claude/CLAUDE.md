...
- `supabase/functions/db-proxy-public/index.ts` — Edge Function 含 SQL allowlist（目前 13 條;Q11 theme_history 180 → 400 days、Q13 新增 ticker_close_history 400 天讀取讓近一年焦點 cluster chart modal 也能畫）
