...
- `supabase/functions/db-proxy-public/index.ts` — Edge Function 含 SQL allowlist（目前 14 條;Q11 theme_history 180→400 days、Q13 ticker_close_history 400 天讀取讓近一年焦點 cluster chart modal 也能畫、Q14 special rows 拉「處置/漲跌停」not-in-top-50 ticker 進 cluster detection）
