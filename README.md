...
```
Supabase DB ──[anon key, 33-pattern allowlist]──▶ Cloudflare Workers
                                                  (public site)
...
The Edge Function enforces a hard allowlist of 33 SELECT shapes — even
...
- `supabase/functions/db-proxy-public/` — Edge Function source (33-pattern allowlist)
