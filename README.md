...
```
Supabase DB ──[anon key, 32-pattern allowlist]──▶ Cloudflare Workers
                                                  (public site)
...
The Edge Function enforces a hard allowlist of 32 SELECT shapes — even
...
- `supabase/functions/db-proxy-public/` — Edge Function source (32-pattern allowlist)
